...
const { student_get, student_get_one } = require('../controllers/studentController')
...
router.get('/users', auth_user(true), auth_user_role(['Admin']), users_get)
...
router.get('/students/:id', student_get_one)
